				...
				<view class="list-music">
					...
					<!-- <view class="list-music-item">
						...
						<view class="list-music-song">
							<view>与我无关</view>
							<view>
								<image src="../../static/独家验证-01.png"></image>
								<image src="../../static/独家验证-01.png"></image>
								阿里 - 与我无关
							</view>
						</view>
					...
					<view class="list-music-item" v-for="(item,index) in playlist.tracks" :key="index" @tap="handleToDetail(item.id)">
						...
						<view class="list-music-song">
							<view>{{item.name}}</view>
							<view>
								<image v-if="privileges[index].flag > 60 && privileges[index].flag < 70" src="../../static/独家验证-01.png"></image>
								<image v-if="privileges[index].maxbr==999000" src="../../static/24gf-rectangle.png"></image>
...
<style scoped>
  ...
  .list-head-text view:nth-child(2){display: flex;align-items: center; margin: 20rpx 0;font-size: 24rpx}
